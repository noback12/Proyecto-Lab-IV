...
<<<<<<< Updated upstream
	public function AgregarPeli($id_pelicula,$nombre,$duracion,$sinopsis,$genero){
...
=======
	public function AgregarPeli($nombre,$duracion,$sinopsis,$genero,$estreno){
		...
		*/
		...
		$this->db->query("INSERT INTO peliculas (id_pelicula,nombre ,duracion,sinopsis,genero,estreno) 
			values (NULL ,'$nombre','$duracion','$sinopsis','$genero','$estreno')	");
>>>>>>> Stashed changes
	}
}
